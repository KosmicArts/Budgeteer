...
var budgetController = (function(){
    ...
    return {
        addItem: function(type, des, val){
            ...
            // Then push into our data structures
...
var UIController = (function(){
    ...
    var DOMstrings = {
        ...
        budgetInc: ".budget__income",
        budgetExp: ".budget__expenses",
    ...
    return {
        ...
        displayBudget: function(obj){
            document.querySelector(DOMstrings.budgetTotal).textContent = formatNumber(obj.budget);
        ...
        displayExpPercentages: function(perc){
            var labels = document.querySelectorAll(DOMstrings.expPercLabel);
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updateBudget = function(){
        ...
        // 3. Update the UI to display the calculated budget
    ...
    var updatePercentages = function(){
        ...
        // 2. Return percentages from the budgetr controller
        var percentages = budgetCtrl.getPercentage();

        // 3. Update UI to display new percentages
    ...
    var ctrlAddItem = function(){
        ...
        if(input.description !== "" && !isNaN(input.value) && input.value > 0){
            // 2. Add the input data to the budget controller
            newItem = budgetCtrl.addItem(input.type, input.description, input.value);

            // 3. Update the UI with added input data
